...
const Hero = () => {
  return (
    <div className='m-auto grid max-w-[90rem] grid-cols-[4fr_5fr] items-center px-24 py-42 gap-x-18'>
        <div className=''>
            <h1 className='text-primary-50 mb-6 text-6xl/18 font-semibold tracking-tight'>AI-Powered Notes. Organize and Summarize in Seconds.</h1>
            ...
            <button className="flex border rounded-full items-center bg-primary-500 border-primary-500 hover:border-primary-50 hover:bg-primary-50 transition-all ease-in-out primary-glow-hover group cursor-pointer gap-x-3 px-8 py-3.5">
