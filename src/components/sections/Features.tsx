...
const Features = () => {
  return (
    <section className='bg-primary-1300 -z-1 overflow-hidden bg-[url("../public/assets/Noise.webp")] bg-repeat px-24 pt-32 pb-32'>
        <div className='text-primary-50 relative m-auto max-w-[90rem] px-24 py-32 max-xl:px-16 max-xl:py-10'>
            ...
            <div className='mb-28 grid grid-cols-2 items-center max-sm:flex max-sm:flex-row-reverse gap-x-16'>
                <figure>
                   <Image src={img1} alt='Smart Organization Iphone Graphic'
                   className='max-h-[45rem] '
                   /> 
                </figure>    
                <div className='z-1 max-w-lg justify-self-end max-md:row-start-1 '>
                    <p className='text-2xl font-bold text-primary-50'>Smart Organization </p>
                    <p className='text-primary-100 z-1 text-xl/loose font-light max-lg:text-base/loose max-xl:text-lg/8 '>Automatically categorize and tag your notes using AI-driven analysis.
                        NoteFlow intelligently identifie key topics and organizes your content,\
                        making it  easy to find and retrieve your notes when you need<br/>
                        them most.
                    </p>
                </div>
            </div>  
            ...
            <div className='grid grid-cols-2 items-center'>
                <div className='max-w-lg justify-self-start'>
                    ...
                    <p className='text-primary-100 z-1 text-xl/loose font-light '>Stay on top of important tasks with AI
